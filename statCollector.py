...
# The data scraping module for the network.
...
def team_scores_reader(txt,team, testPlayer):
    # Function to collect data to train the network.
...
lista = statCollector('https://www.hltv.org/matches/2342371/fnatic-vs-mousesports-cs-summit-6-europe') 
statstoFile(lista, "C:\\Users\\rikuk\\Documents\\AIprojekti\\Koulutus\\peli49\\")
print("Done!")